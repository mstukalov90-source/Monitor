...
-- Moscow MGGT (MSK-77) local CRS — used as source CRS for GPKG import transforms.
...
CREATE TABLE IF NOT EXISTS mggt_station.sps_point (
    ...
    "Geometry" public.geometry(point, 4326) NULL,
    "BasePolyUsage" bool DEFAULT true NULL,
    geometry_fme_type text NULL,
    color text NULL,
    svg_name text NULL,
    object_type text NULL,
    new_cell_name text NULL,
    utf8_cell_name text NULL,
    font integer NULL,
    text_group integer NULL,
    igds_style integer NULL,
    igds_level integer NULL,
    igds_justification integer NULL,
    igds_original_justification text NULL,
